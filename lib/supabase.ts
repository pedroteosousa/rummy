  ...
  public: {
    Tables: {
      game_deck: {
        ...
        Relationships: [
          {
            foreignKeyName: "game_deck_game_id_fkey"
            columns: ["game_id"]
            isOneToOne: false
      ...
      game_users: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "game_users_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      lobbies: {
        ...
        Relationships: [
          {
            foreignKeyName: "lobbies_active_game_id_fkey"
    ...
    Functions: {
      create_lobby_with_host: {
        Args: { host_user_id: string }
        Returns: string
      }
      start_game: { Args: { lobby_id_input: string }; Returns: string }
    }
    Enums: {
      [_ in never]: never
    }
